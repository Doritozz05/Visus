...
const WORD_LIST = [
  "Visus", "presents", "text", "sequentially,",
  "flashing", "one", "word", "at", "a", "time",
  "centered", "at", "the", "optimal", "recognition", "point.",
  "This", "stops", "your", "eyes", "from", "wandering", "back",
  "and", "forth", "across", "the", "page,", "which", "wastes",
  "up", "to", "eighty", "percent", "of", "your", "reading", "time.",
  "By", "keeping", "your", "focal", "point", "completely", "still,",
  "you", "eliminate", "subvocalization,", "the", "habit", "of", "repeating",
  "words", "silently", "in", "your", "head.", "This", "trains", "your",
  "brain", "to", "process", "visual", "language", "directly,",
  "letting", "you", "read", "much", "faster", "while", "retaining",
  "full", "comprehension."
];
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-card border border-border/50 rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
      ...
      <div className="flex justify-between items-center mt-6 relative z-10">
        ...
        <span className="text-[10px] uppercase tracking-widest text-primary/70 font-bold bg-primary/10 px-2 py-1 rounded-md border border-primary/20">450 WPM</span>
      </div>
    </div>
  );
}
