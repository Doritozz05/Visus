...
- The social card (`ShareCard`) includes Visi the mascot, rendered via SVG (for live preview animations) and Canvas paths (for downloadable card consistency) across streak milestones (Day 0, 1, 5, 15).
