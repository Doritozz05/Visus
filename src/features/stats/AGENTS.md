...
- The social card (`ShareCard`) and the interactive achievements showcase (`AchievementsShowcase`) include Visi the mascot, rendered via SVG (for live preview animations) and Canvas paths (for downloadable card consistency) across streak milestones (Day 0, 1, 5, 15, 30, 50, 75, 100, 150, 200, 250, 300, 365, 500, 600, 730, 1000, 1500, 2000, 3000, 5000, 9999).
