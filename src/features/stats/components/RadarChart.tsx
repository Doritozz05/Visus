  ...
  return (
    <div className="bg-card border border-border/20 p-5 rounded-xl flex flex-col items-center justify-between h-full relative group hover:border-primary/40 transition-all shadow-md liquid-glass">
      ...
      <div className="relative" style={{ width: size, height: size }}>
        ...
        {hoveredMetric && (
          <div
            className="absolute bg-popover/90 text-popover-foreground border border-border/40 text-[10px] font-mono px-2 py-1 rounded shadow-xl pointer-events-none backdrop-blur-sm z-30"
            style={{
