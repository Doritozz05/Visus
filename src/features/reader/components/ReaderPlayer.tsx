...
export function ReaderPlayer({
  ...
  return (
    <div className={`w-full max-w-2xl mt-auto mb-4 flex flex-col sm:flex-row items-center justify-between gap-6 bg-card p-4 md:p-6 rounded-xl border border-border/20 shadow-xl z-20 liquid-glass transition-all duration-300 ${
      isFocusMode 
        ? isPlaying 
