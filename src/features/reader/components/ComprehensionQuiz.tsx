...
export function ComprehensionQuiz({
  ...
  if (showResults) {
    ...
    return (
      <div className="w-full max-w-md bg-card border border-border/30 rounded-xl p-5 md:p-6 text-center shadow-2xl liquid-glass relative overflow-hidden flex flex-col items-center justify-center gap-4 transition-all duration-300">
  ...
  return (
    <div className="w-full max-w-lg bg-card border border-border/30 rounded-xl p-4 md:p-5 shadow-2xl liquid-glass relative overflow-hidden flex flex-col gap-4 transition-all duration-300">
      <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-50"></div>
