...
export function ChapterCompletionCard({
  ...
  return (
    <div className="max-w-md w-full mx-auto bg-card border border-border/30 rounded-2xl p-8 text-center shadow-2xl relative overflow-hidden flex flex-col items-center justify-center gap-6 transition-all duration-300">
